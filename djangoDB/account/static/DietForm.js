...
function handleFormSubmissionHealthydiet(event, actionUrl) {
    ...
    Diet_prompt = `Give me a week healthy diet plan for ${gender} ${age} year old that weights ${weight} pound and is allegric to ${Food_Allergies}`;
    localStorage.setItem("Diet_prompt_key", Diet_prompt);
   

    var currentUrl = window.location.href;
    var newUrl = currentUrl.replace("dietform", "diet");
...
function handleFormSubmissionWeightGain(event, actionUrl) {
    ...
    Diet_prompt = `Give me a week for a Weight Gain diet plan for ${gender} ${age} year old that weights ${weight} pounds and want to gain ${weight_difference} pounds and is allegric to ${Food_Allergies}`;
    localStorage.setItem("Diet_prompt_key", Diet_prompt);
...
function handleFormSubmissionWeightLoss(event, actionUrl) {
    ...
    Diet_prompt = `Give me a week for a Weight Loss diet plan for ${gender} ${age} year old that weights ${weight} pounds and  want to lose ${weight_difference} pounds and is allegric to ${Food_Allergies}`;
    localStorage.setItem("Diet_prompt_key", Diet_prompt);
    console.log(Diet_prompt);
...
function handleFormSubmissionVegan(event, actionUrl) {
    ...
    Diet_prompt = `Give me a week for a vegan diet plan for ${weight_control} for a ${gender} ${age} year old that weights ${weight} pounds is allegric to ${Food_Allergies}`;
    localStorage.setItem("Diet_prompt_key", Diet_prompt);
    console.log(Diet_prompt);
...
function handleFormSubmissionKeto(event, actionUrl) {
    ...
    Diet_prompt = `Give me a week for a Keto diet plan for ${weight_control} for a ${gender} ${age} year old that weights ${weight} pounds is allegric to ${Food_Allergies}`;
    localStorage.setItem("Diet_prompt_key", Diet_prompt);
...
function handleFormSubmissionPaleo(event, actionUrl) {
    ...
    Diet_prompt = `Give me a week for a Paleo diet plan for ${weight_control} for a ${gender} ${age} year old that weights ${weight} pounds is allegric to ${Food_Allergies}`;
    localStorage.setItem("Diet_prompt_key", Diet_prompt);
